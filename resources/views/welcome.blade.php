...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center py-4 sm:pt-0">
            ...
            <div class="row">
                ...
                <form method="post" action="{{route('sales')}}"  enctype="multipart/form-data">
                        @if(Session::has('sale_add'))
                            <span class="alert alert-success" style="margin:10px" role="alert">{{Session::get('sale_add')}}</span>
                        @endif
                        @csrf
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" name="price" placeholder="Total Price" required>
 ...
 <!-- <form method="post" action="{{route('sales')}}"  enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" name="merchandisesold" placeholder="Merchandise Sold" required>
                            <label for="floatingInput">Merchandise Sold</label>
                        </div>
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" id="floatingInput" name="price" placeholder="Total Price" required>
